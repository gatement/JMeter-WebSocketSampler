...
public class WebSocketSampler extends AbstractSampler implements TestStateListener {
    ...
    public String getServerPort() {
        ...
        // Fix the websocket port can not be parameterized issue: just return value but do not try parsing it to integer because the value could be a variable string such as '${PORT}'
        /*
